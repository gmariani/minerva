...
/*global saveAs, $, jQuery, Alert, SOL, DictionaryItemView, StringView, VectorView, DateView, ByteArrayView, ArrayView, BooleanView, ObjectView, DictionaryView, SOLView, NumberView, IntegerView, XMLView */
var util = {};
var debug = false;
	...
	util.getOS = function() {
		if ( !os ) {
			var clientStrings = [
					...
					{s:'Windows 2000', r:/(Windows 2000|Windows NT 5.0)/, short:'Win'},
					{s:'Windows XP', r:/(Windows XP|Windows NT 5.1)/, short:'Win'},
					{s:'Windows XP x64', r:/Windows NT 5.2/, short:'Win'},
					...
					{s:'Windows 10', r:/(Windows 10|Windows NT 10.0)/, short:'Win'},
...
$(function () {
	...
	switch (os.short) {
		case 'Win' : path += '%APPDATA%\\Macromedia\\Flash Player\\'; break;
