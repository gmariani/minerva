var VectorView = function() {
	...
	function init(el/*:Element */, node/*:Object */, input/*:Object */, callBack/*:Function */)/*:void */ {
		// Generate HTML
		el.html('<h1>Vector</h1><div></div>' + googlead);
		...
		var str = '<p><strong>Class:</strong> <code>' + node.data.__traits.class + '</code></p>';
		if (node.data.__traits.hasOwnProperty('fixed')) str += '<p><strong>Is Fixed?</strong> <span>' + node.data.__traits.fixed + '</span></p>';
		...
		el.children('h1').html('Vector.&lt;' + node.data.__traits.class + '&gt;');
	}
