...
var ObjectView = function() {
    ...
    function init(
        ...
        if (node.data.__traits.hasOwnProperty('class'))
            str +=
        ...
        if (node.data.__traits.hasOwnProperty('dynamic')) {
            str +=
                '<p><strong>Is Dynamic?</strong> <span>' +
                node.data.__traits.dynamic +
                '</span></p>';
        ...
        if (node.data.__traits.hasOwnProperty('externalizable')) {
            str +=
                '<p><strong>Is Externalizable:</strong> <span>' +
                node.data.__traits.externalizable +
                '</span></p>';
        ...
        if (node.data.__traits.hasOwnProperty('count'))
            str +=
                '<p><strong>Member Count:</strong> ' +
                node.data.__traits.count +
                '</p>';
        if (node.data.__traits.hasOwnProperty('members'))
            str +=
                '<p><strong>Members:</strong> <code>' +
                JSON.stringify(node.data.__traits.members, null, '\t') +
                '</code></p>';
